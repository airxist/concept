...
const WorkSpace = () => {
  return (
    <Section className="relative min-h-4">
      <WorkSpaceForm />
      <div className="normal-pad  mt-10 md:mt-48 border">
        <Heading
                ...
                return (
                  <div key={spaceIndex} className="absolute  h-full  bg-white">
                    <div className="bg-white">
                      <p className="text-xl underline underline-offset-8 text-custom_blue font-semibold">
                        {spaces.title}
                      </p>
                    </div>
                    ...
                    <Button className="bg-custom_blue text-white text-[0.713rem] py-2.5 px-[1.12rem] mt-auto">
                      Explore More
                    </Button>
                  </div>
                );
        ...
        <div className="grid grid-cols-4 mt-24">
          {companyReach.map((reach, reachIndex) => {
            return <div key={reachIndex} className="col-span-1">
              <h2 className="text-gradient text-8xl font-extrabold text-center">{reach.count}+</h2>
              <p className="text-center text-[2rem] font-normal">{reach.title}</p>
            </div>;
          })}
        </div>
      </div>
